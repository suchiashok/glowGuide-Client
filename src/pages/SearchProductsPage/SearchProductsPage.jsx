          ...
          <div className="aboutContainer">
            <div className="aboutContainer__content">
              ...
              <p className="aboutContainer__para">
                Welcome to glowGuide, your trusted resource for discovering the
                top skincare products available today. Our platform offers
                comprehensive information and expert insights on a wide range of
                beauty essentials, from hydrating moisturizers to powerful
                ...
                the best options tailored to your needs. Dive into our detailed
                reviews and guides to find the perfect products that will
                elevate your skincare routine and help you achieve a radiant,
                healthy complexion.
              </p>
            </div>
            <div className="aboutContainer__content">
              ...
              <p className="aboutContainer__para">
                Skincare is not just about aesthetics; it's a vital component of
                overall health and well-being. As the body's largest organ, the
                skin serves as a crucial barrier against environmental
                ...
                <br />
                <br />
                Effective skincare practices can prevent premature aging, reduce
                the risk of skin conditions, and enhance your natural beauty.
                Moreover, dedicating time to skincare is an act of self-care,
                fostering mental wellness by allowing you to connect with and
                care for yourself. Prioritizing skincare today paves the way for
                a healthier, more luminous complexion in the future.
              </p>
            </div>
          </div>
            ...
            {products.map((product) => (
              <div key={product.id} className="card">
                ...
                <div className="card__buttonEl">
                  <button className="card__button">KNOW MORE</button>
                  <img
